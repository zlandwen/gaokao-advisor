...
class ZhangXuefengTrainer:
    ...
    def drill_data_memory(self):
        ...
        core_data = [
            ...
            ("行业薪资","腾讯大模型算法校招月薪峰值","5.2万/月","5.2"),
            ("行业薪资","深圳具身智能工程师平均月薪","6.16万","6.16"),
            ...
            ("高考数据","广东省每年高考人数约","80万人","80"),
            ("企业数据","深圳AI规上企业数(2026)","2600+家","2600"),
            ("企业数据","深圳南山区平均月薪","2.17万","2.17"),
            ("企业数据","大模型算法工程师年薪","50-80万x18薪","50"),
            ("企业数据","优必选首席科学家年薪峰值","1.24亿","1.24"),
        ]
